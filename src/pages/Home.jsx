...
export default function Home() {
  return (
    <>
      ...
      <section className="relative p-15 min-h-[90vh] flex items-center overflow-hidden bg-[#0a0a0a]">
        ...
        ></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500] h-[500] bg-orange-500/5 rounded-full blur-3xl"></div>
